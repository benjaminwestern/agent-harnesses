---
id: collaborative_review_inline
name: Collaborative jury with inline judge and final judge
routing: clerk
...
Use a clerk to route work, let the inline judge supervise, then let the final judge decide. Missing juror targets are auto-filled heuristically, and failed juror-assignment lanes retry once with backoff.
