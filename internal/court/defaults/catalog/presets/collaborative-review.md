...
name: Collaborative jury with final judge
routing: clerk
...
Use a clerk to route work, then hand the evidence to the final judge. Missing juror targets are auto-filled heuristically, and failed juror-assignment lanes retry once with backoff.
