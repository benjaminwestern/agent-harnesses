---
id: convention_over_configuration_jury_only
aliases: coc-jury,grug-jury
name: Convention over configuration jury only
routing: clerk
...
The same convention-over-configuration specialist jury without a final judge.
